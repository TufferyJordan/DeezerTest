...
import com.deezer.test.albumdetail.AlbumDetailViewModel
...
import com.deezer.test.tracklist.TrackListViewModel
...
object Modules {
    ...
    val repositories = module {
        single { GetAlbumListRepository(get()) }
        single { GetAlbumRepository(get()) }
        single { GetTrackListRepository(get()) }
    }

    val viewModels = module {
        viewModel { AlbumListViewModel(get(), get()) }
        viewModel { AlbumDetailViewModel(get(), get<Context>().resources) }
